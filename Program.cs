...
namespace SROMLab1 {
    class Program {
        static void Main(string[] args) {
            ...
            var a_32 = new ulong[16];
            var b_32 = new ulong[16];
            var c_32 = new ulong[16];
            ToArr(a, a_32);
            ToArr(b, b_32);
            ToArr(c, c_32);
        ...
        public static ulong[] Division(ulong[] a_32, ulong[] b_32/*, ulong[] x_32*/) {
            var b = new ulong[16];
